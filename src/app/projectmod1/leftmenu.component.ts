//import { Menu } from './../../../../ani-codekul/ani-codekul-angular2/angular2-morning-14-dec-16/src/app/projectmod1/leftmenu.component';
...
private menus : Menu[];
    ...
    this.menus.push(new Menu('Android',
    'https://pbs.twimg.com/profile_images/616076655547682816/6gMRtQyY.jpg',
  'humenoid','Android is a mobile operating system,based on the Linux kernl'));
